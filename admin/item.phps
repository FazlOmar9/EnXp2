...
<body>
    ...
    <?php
    // First column contains tablename, second is col1 which contains the name of the column of the table and Third is col2 which contains the name of the another column of the table 
